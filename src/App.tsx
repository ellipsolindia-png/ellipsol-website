          ...
          <div className="space-y-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative group overflow-hidden rounded-3xl shadow-2xl border-4 border-white bg-stone-200 order-1 md:order-2">
                <div className="absolute inset-0 bg-gradient-to-br from-white-500/20 to-white-600/20 group-hover:from-orange-500/30 group-hover:to-orange-600/30 transition-all z-10"></div>
                <img
